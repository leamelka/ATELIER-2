    ...
    public partial class frmGestionPersonnel : Form
    {
        ...
        public void ShowComponents(bool show)
        {
            ...
            if (!show)
            {
                ...
                btnSwitch.Text = "VOIR LES ABSENCES  →";
                lblGauche.Text = "FICHE DU PERSONNEL";
                lblDroit.Text = "LISTE DES PERSONNELS";
            }
            else
            {
                // GESTION DES ABSENCES
                ...
                btnSwitch.Text = "RETOUR  →";
                lblGauche.Text = "DÉTAIL DE L'ABSENCE";
                lblDroit.Text = "LISTE DES ABSENCES";
            }
        }
